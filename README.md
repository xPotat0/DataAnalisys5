...
График Policy Loss - Функция потерь, показывает, изучила ли модель информацию. Если график "скачет", то модель ничего не выучила. Если график плавная линия, которая стремится к прямой, то модель изучила информацию.

Наш график получился кривым. Чтобы сделать функцию потерь более плавной уменьшим скорость обучения модели. 
